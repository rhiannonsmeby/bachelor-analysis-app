...
class SaveDataSummary extends React.Component {
    ...
    handleSubmit = e => {
        e.preventDefault();
        const content = `${(this.props.location.state).length} contestants from show "${this.props.location.state.show}" season "${this.props.location.state.selectedSeason}" have the "${this.props.location.state.topic}" matching "${this.props.location.state.keyword}"`
            ...
            <div className='AddSummary'>
                ...
                <form className='addSummaryForm' onSubmit={this.handleSubmit}>
                    <fieldset>
                        ...
                        <br></br>
                        <p className='summary-content'>{(this.props.location.state).length} contestants from show '{this.props.location.state.show}' season '{this.props.location.state.selectedSeason}' have the '{this.props.location.state.topic}' matching '{this.props.location.state.keyword}'</p>
                        <br />
